        ...
        <OverviewCard>
            ...
            <div className={styles.rbOverviewContainer}>
                <div className={styles.rbOverviewItem}>
                    <div
                        className={`${styles.rbOverviewIndicator} ${styles.indicatorPaid}`}
                    />
                    <div className={styles.rbOverviewContent}>
                        <h3 className={styles.rbOverviewText}>Paid Bills</h3>
                        <p className={styles.rbOverviewAmount}>
                            ${paidBills || '0.00'}
                        </p>
                    </div>
                </div>
                ...
                <div className={styles.rbOverviewItem}>
                    <div
                        className={`${styles.rbOverviewIndicator} ${styles.indicatorUpcoming}`}
                    />
                    <div className={styles.rbOverviewContent}>
                        <h3 className={styles.rbOverviewText}>
                            Upcoming Bills
                        </h3>
                        <p className={styles.rbOverviewAmount}>
                            ${upcomingBills || '0.00'}
                ...
                <div className={styles.rbOverviewItem}>
                    <div
                        className={`${styles.rbOverviewIndicator} ${styles.indicatorDueSoon}`}
                    />
                    <div className={styles.rbOverviewContent}>
